...
trait Dropdowns
{
     ...
     * @return mixed
     */
    public function selectAgency($name, $selected = null, $options = [])
	{
		$agencies = Agency::lists('name', 'id')->toArray();
		$agencies = ['' => 'Pilih Agensi'] + $agencies;
		return $this->select($name, $agencies, $selected, $options);
	}

	public function selectEvent($name, $selected = null, $options = [])
	{
		$events = Event::lists('name', 'id')->toArray();
		$events = ['' => 'Pilih Aktiviti'] + $events;
		return $this->select($name, $events, $selected, $options);
	}

	public function selectCategory($name, $selected = null, $options = [])
	{
		$categories = Category::lists('name', 'id')->toArray();
		return $this->select($name, $categories, $selected, $options);
	}
