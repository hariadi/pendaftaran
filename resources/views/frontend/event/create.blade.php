...
@section('content')
	...
	<div class="box box-success">
        <div class="box-body">
            <div class="pull-left">
                <a href="{{route('frontend.user.dashboard') }}" class="btn btn-danger btn-lg">{{ trans('buttons.general.cancel') }}</a>
            </div>

            <div class="pull-right">
                <input type="submit" class="btn btn-success btn-lg" value="{{ trans('buttons.general.crud.create') }}" />
            </div>
