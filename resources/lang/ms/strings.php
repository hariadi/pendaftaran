...
return [
    ...
    */
    ...
    'frontend' => [
        'email' => [
            'confirm_account' => 'Klik sini untuk mengesahkan akaun anda:',
        ],
        ...
        'user' => [
            ...
            'password_updated' => 'Katalaluan berjaya dikemaskini.',
        ],

        'role' => 'Peranan',

        'welcome_to' => 'Selamat datang ke :place',
    ],
];
